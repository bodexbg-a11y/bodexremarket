...
const storageProducts: Array<{ title: LocalText; use: LocalText; image: string }> = [
  {
    title: { bg: "Полуремарке-цистерна за гориво", ar: "نصف مقطورة صهريج لنقل الوقود" },
    use: { bg: "За транспортиране на течни горива", ar: "لنقل أنواع الوقود السائل" },
    image: "/products/tanks/fuel.jpg",
  },
  {
    title: { bg: "Полуремарке-цистерна за дизелово гориво", ar: "نصف مقطورة صهريج لنقل وقود الديزل" },
    use: { bg: "За транспортиране на дизелово гориво", ar: "لنقل وقود الديزل" },
    image: "/products/tanks/diesel.jpg",
  },
  {
    title: { bg: "Полуремарке-цистерна за бензин", ar: "نصف مقطورة صهريج لنقل البنزين" },
    use: { bg: "За транспортиране на бензин", ar: "لنقل البنزين" },
    image: "/products/tanks/petrol.jpg",
  },
  {
    title: { bg: "Полуремарке-цистерна за мазут", ar: "نصف مقطورة صهريج لنقل المازوت" },
    use: { bg: "За транспортиране на мазут", ar: "لنقل المازوت" },
    image: "/products/tanks/mazut.jpg",
  },
  {
    title: { bg: "Полуремарке-цистерна за масла", ar: "نصف مقطورة صهريج لنقل الزيوت" },
    use: { bg: "За транспортиране на технически и моторни масла", ar: "لنقل الزيوت التقنية وزيوت المحركات" },
    image: "/products/tanks/oils.jpg",
  },
  {
    title: { bg: "Полуремарке-цистерна за хранителни продукти 40 м³", ar: "نصف مقطورة صهريج للمواد الغذائية 40 م³" },
    use: { bg: "От хранителна неръждаема стомана за хранителни продукти", ar: "من الفولاذ المقاوم للصدأ المخصص لنقل المواد الغذائية" },
...
const featured = [
  {
    ...
    text: {
      bg: "Конфигурации с клапа, комбинирана врата и решения за скрап. Конструкции от Hardox® 450/500 Tuf и Domex.",
...
const copy = {
  bg: {
    ...
    storageLabel: "Полуремаркета-цистерни", storageTitle: "Цистерни за горива и хранителни продукти.", storageText: "В нашата гама ще намерите полуремаркета-цистерни за превоз на гориво, дизелово гориво, бензин, мазут и масла, както и продуктова цистерна 40 м³ от хранителна неръждаема стомана.", storageCustom: "Оферта по запитване", storageButton: "Запитване за цистерна",
    ...
    about: ["BODEX BULGARIA е дилър с широка гама полуремаркета и транспортни решения, включително полуремаркета-цистерни за българския пазар.", "Помагаме при избора на подходящ модел и конфигурация според товара, маршрутите и конкретната транспортна задача."],
  ...
  ar: {
    ...
    storageLabel: "نصف مقطورات صهريج", storageTitle: "صهاريج للوقود والمواد الغذائية.", storageText: "تشمل مجموعتنا نصف مقطورات صهريج لنقل الوقود ووقود الديزل والبنزين والمازوت والزيوت، بالإضافة إلى صهريج للمواد الغذائية بسعة 40 م³ من الفولاذ المقاوم للصدأ المخصص للأغذية.", storageCustom: "عرض سعر عند الطلب", storageButton: "طلب صهريج",
    ...
    about: ["BODEX BULGARIA موزع يقدم للسوق البلغاري مجموعة واسعة من نصف المقطورات وحلول النقل، بما في ذلك نصف مقطورات الصهاريج.", "نساعدك في اختيار الموديل والتجهيز المناسبين حسب الحمولة والمسارات ومهمة النقل المطلوبة."],
